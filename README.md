...
https://img.shields.io/badge/language-C%252B%252B-orange.svg
...
Ключевые компоненты
Сетевой слой — управление подключениями через WinSock

Игровой движок — логика морского боя

Менеджер сессий — управление игровыми комнатами
...
Сервер и клиент ведут логирование в консоль:
...
Для отладки рекомендуется запускать сервер в отдельном окне командной строки.
